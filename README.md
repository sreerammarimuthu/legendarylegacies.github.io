...
- Crime and victimization trends over time
...
The full project was integrated into Legendary Legacies’ public site to strengthen their outreach, strategic planning, and impact communication.

## Tools

- HTML, CSS, and Plotly for visualization
- GitHub Pages for hosting and version control

## Live Dashboard

View the live dashboard hosted on Legendary Legacies' public site here: https://legendlegacy.org/research-data/    
